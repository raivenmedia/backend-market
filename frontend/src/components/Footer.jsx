      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="font-display font-black text-2xl tracking-tighter text-gray-900 mb-4">
              ApexCole.
            </h3>
            <p className="text-gray-500 text-sm mb-6">
              A modern, premium marketplace for everyone. Discover, buy, and sell extraordinary items.
            </p>
          ...
          {/* About Column */}
          <div>
            <h4 className="font-bold text-gray-900 mb-4 tracking-wide">About</h4>
          ...
          {/* Help Column */}
          <div>
            <h4 className="font-bold text-gray-900 mb-4 tracking-wide">Help</h4>
            <ul className="space-y-3 text-sm text-gray-500">
              <li><a href="#" className="hover:text-gray-900 transition-colors">Customer Service</a></li>
              <li><a href="#" className="hover:text-gray-900 transition-colors">Returns & Exchanges</a></li>
              <li><a href="#" className="hover:text-gray-900 transition-colors">Shipping Options</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm text-center md:text-left mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} ApexCole Marketplace. All rights reserved.
          </p>
